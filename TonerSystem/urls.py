...
urlpatterns = patterns('',
    ...
    url(r'^list_cartridges/(?P<id>[^/]+)/$', views.list_cartridges_id, name='list_cartridges_id'),
    ...
    url(r'^consult_id_cartridge$', views.consult_id_cartridge , name='consult_id_cartridge '),
